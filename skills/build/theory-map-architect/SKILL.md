...
description: Produziert ein zweiseitiges strategisches Theorie-Memo für konfigurationale (fsQCA, QCA) und qualitative (Gioia, Grounded Theory, case study) Paper, deren Ergebnisse stehen, deren theoretisches Artefakt aber unscharf ist. Trifft die drei Entscheidungen zwischen Empirie und Schreiben – Kernlinse, Hilfslinse, Artefakt-Genre (middle-range, propositions, abductive theory extension, typologisch, process) – und auditiert Eigenkonstrukte auf Verankerung inklusive Kanonisch-Naming-Check. Trigger auf "Theory Map", "welche Theorie trägt mein Paper", "middle-range oder propositions paper", "abductive theory extension", "Kernlinse Hilfslinse", "meine fsQCA-Solutions stehen", "meine aggregate dimensions stehen", "welche Referenzpaper imitieren", "freischwebende Konstrukte verankern". NICHT für Prosa (theory-section-architect), Theorietyp (mulcahy-theory-diagnostics) oder RQ (rq-architect). Produziert KEINE Prosa, sondern Entscheidungsgrundlage.
---
